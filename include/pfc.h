...
class PFC {
 ...
 private:
  // determines destination cell and parts of flux between it and nighbouring
  // one
 ...
 private:
  double *f1, *f2, *conc;
  Mesh *mesh;
  double N0,    // critical concentration in a boosted frame (useful for
                // simulation of oblique irradiation)
      P0;       // initial mean momentum along y-axis (useful for simulation of
                // oblique irradiation in boosted frame)
